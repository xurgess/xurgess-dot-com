...
import {
  ...
  transition,
  trigger
} from "./chunk-2U5EFUZO.js";
import {
  ArrayDataSource,
  _RecycleViewRepeaterStrategy,
  _VIEW_REPEATER_STRATEGY,
  isDataSource
} from "./chunk-ITIPGB6J.js";
import {
  BidiModule,
  Directionality,
  ESCAPE,
...
} from "./chunk-OSP4FGNL.js";
import {
  DOCUMENT
} from "./chunk-ATXRZ446.js";
import {
...
var MatDrawerContainer = class _MatDrawerContainer {
  ...
  _watchDrawerPosition(drawer) {
    ...
    drawer.onPositionChanged.pipe((0, import_operators2.takeUntil)(this._drawers.changes)).subscribe(() => {
      this._ngZone.onMicrotaskEmpty.pipe((0, import_operators2.take)(1)).subscribe(() => {
        this._validateDrawers();
      });
    });
  }
